...
if __name__ == "__main__":
    parser = argparse.ArgumentParser() # argument parser ARG

    parser.add_argument('-a', '--address', type=str,required=True) # IP addr
    parser.add_argument('-p', '--port', type=int, required=True) # port
    parser.add_argument('-u', '--username', type=str) # username
    parser.add_argument('-pw', '--password', type=str) # pass
